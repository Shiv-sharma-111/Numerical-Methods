//Program to find root of a function, f(x) 
#include<bits/stdc++.h> 
using namespace std; 
  
const int MAX_ITERATIONS = 10000; //take the iterations according to your question
...
int main() 
{ 
// take the values  of a ,b & c according to question
    float a,b,c;
